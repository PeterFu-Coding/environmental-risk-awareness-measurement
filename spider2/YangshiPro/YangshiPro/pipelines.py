...
class YangshiproPipeline:
    ...
    def process_item(self, item, spider):
        ...
        sql = "insert into *** " \
              "values ('%s','%s','%s','%s','%s','%s','%s','%d')"%(item['title'],item['origin_title'],item['info'],item['content'],item['keyword'],item['url'],item['id'],1)
        try:
...
class YangshiProPipelineToText:
    ...
    def process_item(self,item,spider):
        ...
        self.fp.write(item['origin_title']+'\n')
